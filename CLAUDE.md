...
- **LLM:** `anthropic` SDK — `claude-3-5-haiku-latest` for CSV schema detection only
...
This project is indexed by GitNexus as **net_alpha** (1688 symbols, 3887 relationships, 138 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
