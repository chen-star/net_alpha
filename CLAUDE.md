...
This project is indexed by GitNexus as **net_alpha** (621 symbols, 1378 relationships, 23 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
