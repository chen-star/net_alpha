...
This project is indexed by GitNexus as **net_alpha** (4465 symbols, 11822 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
