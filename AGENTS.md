...
This project is indexed by GitNexus as **net_alpha** (3426 symbols, 9001 relationships, 285 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
