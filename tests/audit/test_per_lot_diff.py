    ...
    seed_import(
        ...
        [
            Trade(
                ...
                action="Buy", quantity=100, cost_basis=2000.0,
            ),
            Trade(
                account="Schwab/Tax", date=date(2025, 6, 1), ticker="AAPL",
                action="Sell", quantity=100, proceeds=5000.0, cost_basis=2000.0,
            ),
        ],
    )
    repo.add_gl_lots(
        ...
        lots=[
            RealizedGLLot(
                ...
                closed_date=date(2025, 6, 1), opened_date=date(2024, 1, 10),
                quantity=40.0, proceeds=2000.0, cost_basis=800.0,
                unadjusted_cost_basis=800.0, wash_sale=False, disallowed_loss=0.0,
                term="Long Term",
            ),
            RealizedGLLot(
                account_display="Schwab/Tax", symbol_raw="AAPL", ticker="AAPL",
                closed_date=date(2025, 6, 1), opened_date=date(2024, 6, 15),
                quantity=35.0, proceeds=1750.0, cost_basis=700.0,
                unadjusted_cost_basis=700.0, wash_sale=False, disallowed_loss=0.0,
                term="Long Term",
            ),
            RealizedGLLot(
                account_display="Schwab/Tax", symbol_raw="AAPL", ticker="AAPL",
                closed_date=date(2025, 6, 1), opened_date=date(2025, 1, 5),
                quantity=25.0, proceeds=1250.0, cost_basis=500.0,
                unadjusted_cost_basis=500.0, wash_sale=False, disallowed_loss=0.0,
                term="Short Term",
            ),
        ],
    )
